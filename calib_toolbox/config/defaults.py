...
# -----------------------------------------------------------------------------
_C.DATA = CN()
_C.DATA_PATH = "../data/2019-06-14-sample/calib_data.json"
...
_C.CAM_CONTROLLER.SCRIPT_PATH = "../utils/Photoneo"
...
_C.CALIBRATION.TARGET_DIR = "../data/flange_ground_truth/flange_franka.pcd"
_C.CALIBRATION.SOURCE_DIR = "../data/flange_ground_truth/flange_franka_ref.pcd"
...
# Path for piont file
_C.PATH_GENERATOR.POINT_PATH = "../config_files/predef_pos_franka.txt"
