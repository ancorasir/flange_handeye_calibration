...
# --------------- Setup options ---------------
workspace_limits = np.asarray([[0.03, 0.32], [0.39,0.73], [0.38, 0.58]]) # Cols: min max, Rows: x y z (define workspace limits in robot coordinates)
...
import urx, tf
robot_ip = "192.168.31.10" # The remote robot_ip
