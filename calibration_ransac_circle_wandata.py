...
data_path = "/home/bionicdl/git-project/flange_handeye_calibration/data/2019-05-28/10:42:27"
...
# circle fitting
p_robot = np.load("calibration_robot_pose_data.npy")
p_robot_used = []
maxD = 0.3
R_FLANGE = 31.0
detR = 1 #
